...
However, the broken symmetry results in a large number of free parameters, leading to a huge phasespace in which to search. So far no evidence of SUSY has been observed.
