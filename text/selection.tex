...
% if(fabs(m1245- Bs0_PDG)<50)  passVetos = false;
% if(fabs(m345 - Ds_PDG )<25)  passVetos = false;
% if(fabs(m345 - D_PDG  )<25)  passVetos = false;

% if(fabs(m135 - Ds_PDG) <25)  passVetos = false;
% if(fabs(m234 - Ds_PDG) <25)  passVetos = false;
...
\end{tabular}
\end{center}
\caption{The \emph{Stripping Line} requirements for \decay{\phiz}{\Kp\Km} candidates in the signal and control channel selection. All requirements are looser for the control channel with the exception of the particle identification and \phiz \pt requirements.}
...
\begin{table}[h]
   \begin{center}
      ...
      \end{tabular}
   \end{center}
   \caption{Ranking of variables used to train the \phiz MVA.}
   \label{tab:mvarank_ds}
\end{table}


% --- BDTG                     :    1 : \Kp MC15TuneV1_ProbNNk     : 7.639e-02
% --- BDTG                     :    2 : \Km MC15TuneV1_ProbNNk     : 6.043e-02
% --- BDTG                     :    3 : \Kp $\log(\chi^{2}_{\text{IP}})$     : 5.469e-02
% --- BDTG                     :    4 : \pip $\log(\chi^{2}_{\text{IP}})$      : 4.984e-02
% --- BDTG                     :    5 : \Kp P                      : 4.348e-02
% --- BDTG                     :    6 : \Dsp $\log(\chi^{2}_{\text{IP}})$        : 4.100e-02
% --- BDTG                     :    7 : \pip PT                      : 3.953e-02
% --- BDTG                     :    8 : \Kp PT                     : 3.937e-02
% --- BDTG                     :    9 : \pip MC15TuneV1_ProbNNpi     : 3.881e-02
% --- BDTG                     :   10 : \Dsp $\log(\chi^{2}_{\text{FD}})$        : 3.788e-02
% --- BDTG                     :   11 : \Km $\log(\chi^{2}_{\text{IP}})$     : 3.735e-02
% --- BDTG                     :   12 : \Dsp $\log(ENDVERTEX_CHI2)$      : 3.016e-02
% --- BDTG                     :   13 : \Km P                      : 2.770e-02
% --- BDTG                     :   14 : \Kp MC15TuneV1_ProbNNp     : 2.758e-02
% --- BDTG                     :   15 : \Km MC15TuneV1_ProbNNp     : 2.692e-02
% --- BDTG                     :   16 : \pip MC15TuneV1_ProbNNghost  : 2.623e-02
% --- BDTG                     :   17 : \Kp MC15TuneV1_ProbNNghost : 2.593e-02
% --- BDTG                     :   18 : \Dsp PT                        : 2.543e-02
% --- BDTG                     :   19 : \Kp MC15TuneV1_ProbNNpi    : 2.525e-02
% --- BDTG                     :   20 : \Km PT                     : 2.355e-02
% --- BDTG                     :   21 : \Dsp P                         : 2.327e-02
% --- BDTG                     :   22 : \Km MC15TuneV1_ProbNNpi    : 2.226e-02
% --- BDTG                     :   23 : \pip P                       : 2.083e-02
% --- BDTG                     :   24 : \pip MC15TuneV1_ProbNNp      : 1.849e-02
% --- BDTG                     :   25 : \pip MC15TuneV1_ProbNNk      : 1.793e-02
% --- BDTG                     :   26 : \Km MC15TuneV1_ProbNNghost : 1.607e-02
% --- BDTG                     :   27 : \pip BDT_TRACK_VeloCHI2NDOF  : 1.589e-02
% --- BDTG                     :   28 : \Km TRACK_CHI2NDOF         : 1.588e-02
% --- BDTG                     :   29 : \pip TRACK_MatchCHI2         : 1.548e-02
% --- BDTG                     :   30 : \Kp TRACK_CHI2NDOF         : 1.522e-02
% --- BDTG                     :   31 : \Km TRACK_MatchCHI2        : 1.442e-02
% --- BDTG                     :   32 : \pip TRACK_CHI2NDOF          : 1.433e-02
% --- BDTG                     :   33 : \Kp BDT_TRACK_VeloCHI2NDOF : 1.184e-02
% --- BDTG                     :   34 : \Kp TRACK_MatchCHI2        : 1.176e-02
% --- BDTG                     :   35 : \Km BDT_TRACK_VeloCHI2NDOF : 8.818e-03
