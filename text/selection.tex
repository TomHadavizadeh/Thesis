...
The sample of \Dsp mesons is obtained from the decay \decay{\Bsb}{\Dsp\pim}. Similarly, the sample of \phiz mesons is obtained from 
\decay{\Bs}{\jpsi\phiz} decays. Large, pure samples are reconstructed using similar requirements to those applied in the selection of signal \Dsp and \phiz mesons. The 
...
The MVA method used in this analysis is a gradient Boosted Decision Tree (BDTG)~\cite{Breiman}. The selection criteria for each of the BDTG classifiers are determined by optimising the Punzi figure of merit~\cite{Punzi:2003bu}, 
\begin{equation}
