...
\item \textbf{Momentum:} The momentum, \ptot, of the particle or combination of particles.
\item \textbf{Transverse momentum:} The projection of the total momentum \ptot on the plane perpendicular to the proton beam axis.

\item \textbf{Lifetime:} The time taken for the candidate to travel from its origin vertex to its decay vertex.

\item \textbf{Products \pt scalar sum:} The sum of the magnitudes of the transverse momentum for each of the decay products, $\sum{|\pt|}$.
\item \textbf{Vertex quality:} The minimised value of $\chi^{2}/N_{\text{DOF}}$ as determined in the fit to the vertex location.

\item \textbf{Track quality:} The minimised value of $\chi^{2}/N_{\text{DOF}}$ as determined in the fit track hits.

\item \textbf{Impact parameter:} The shortest distance between a given track and the primary vertex location, as shown in Fig.~\ref{fig:impact_parameter}. 
\item \textbf{Impact parameter significance:} The difference of a given vertex's $\chi^{2}/N_{\text{DOF}}$ with and without a specific track included in the fitting procedure.

\item \textbf{Flight distance significance:} A measure of the

\item \textbf{Distance of closest approach:} The shortest distance between two tracks.
