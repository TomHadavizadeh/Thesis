...
\begin{figure}[!h]
   ...
   \end{subfigure}
   \caption{Training distributions in the signal (blue) and background (red) samples for the Run~II \decay{\phiz}{\Kp\Km} MVA.}
...
\begin{figure}[!h]
   ...
   \end{subfigure}
   \caption{Training distributions in the signal (blue) and background (red) samples for the Run~II \decay{\Dsp}{\Kp\Km\pip} MVA.}
