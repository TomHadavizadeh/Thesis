...
{\color{red}
The \decay{\phiz}{\Kp\Km} MVA is also used to select the \Kp\Km pair in \decay{\Bp}{\Dsp\Kp\Km} decays. Due to the similar topologies of \decay{\Bp}{\Dsp\Kp\Km} \decay{\Bp}{\Dsp\phiz} decays, the \Kp\Km pair share lots of similarities to their \decay{\phiz}{\Kp\Km} counterparts. One obvious difference is the invariant mass of the pair, as the \decay{\Bp}{\Dsp\Kp\Km} decays includes a much larger phase space. In training the MVA this could lead to the selection being non-{}optimal for \decay{\Bp}{\Dsp\Kp\Km} decays with high $m(\Kp\Km)$. However, when determining the efficiency of the selection using these same \decay{\Bs}{\jpsi\phi} decays these differences could lead to bias. Studies are performed to assess the dependence of efficiency on $m(\Kp\Km)$ and an alternative method of determining the efficiency is used for \decay{\Bp}{\Dsp\Kp\Km} decays, as detailed in Section~\ref{sec:B2DsKK_effcorrection}.
}
...
%           2 & \phiz $\log(\chi^{2}_{\text{IP}})$   & $6.001\times 10^{-2}$ \\
%           3 & \Km $\log(\chi^{2}_{\text{IP}})$     & $5.997\times 10^{-2}$ \\
%           4 & \phiz $\log(\chi^{2}_{\text{VTX}})$  & $5.827\times 10^{-2}$ \\
%           5 & \Km ProbNNpi                         & $5.826\times 10^{-2}$ \\
%           6 & \Kp $\log(\chi^{2}_{\text{IP}})$     & $5.761\times 10^{-2}$ \\
...
%           3 & \Kp $\log(\chi^{2}_{\text{IP}})$   & $5.469\times10^{-2}$ \\
%           4 & \pip $\log(\chi^{2}_{\text{IP}})$  & $4.984\times10^{-2}$ \\
%           5 & \Kp \ptot                          & $4.348\times10^{-2}$ \\
%           6 & \Dsp $\log(\chi^{2}_{\text{IP}})$  & $4.100\times10^{-2}$ \\
%           7 & \pip \pt                           & $3.953\times10^{-2}$ \\
%           8 & \Kp \pt                            & $3.937\times10^{-2}$ \\
%           9 & \pip ProbNNpi                      & $3.881\times10^{-2}$ \\
%          10 & \Dsp $\log(\chi^{2}_{\text{FD}})$  & $3.788\times10^{-2}$ \\
%          11 & \Km $\log(\chi^{2}_{\text{IP}})$   & $3.735\times10^{-2}$ \\
%          12 & \Dsp $\log(\chi^{2}_{\text{VTX}})$ & $3.016\times10^{-2}$ \\
...
\hline
 ...
 2 & \Km ProbNNk                        & $6.043\times10^{-2}$ &  2 & \phiz $\log(\chi^{2}_{\text{IP}})$   & $6.001\times 10^{-2}$\\
 3 & \Kp $\log(\chi^{2}_{\text{IP}})$   & $5.469\times10^{-2}$ &  3 & \Km $\log(\chi^{2}_{\text{IP}})$     & $5.997\times 10^{-2}$\\
 4 & \pip $\log(\chi^{2}_{\text{IP}})$  & $4.984\times10^{-2}$ &  4 & \phiz $\log(\chi^{2}_{\text{VTX}})$  & $5.827\times 10^{-2}$\\
 5 & \Kp \ptot                          & $4.348\times10^{-2}$ &  5 & \Km ProbNNpi                         & $5.826\times 10^{-2}$\\
 6 & \Dsp $\log(\chi^{2}_{\text{IP}})$  & $4.100\times10^{-2}$ &  6 & \Kp $\log(\chi^{2}_{\text{IP}})$     & $5.761\times 10^{-2}$\\
...
10 & \Dsp $\log(\chi^{2}_{\text{FD}})$  & $3.788\times10^{-2}$ & 10 & \Km $\chi^{2}_{\text{TRK}}$          & $5.201\times 10^{-2}$\\
11 & \Km $\log(\chi^{2}_{\text{IP}})$   & $3.735\times10^{-2}$ & 11 & \Kp ProbNNpi                         & $5.162\times 10^{-2}$\\
12 & \Dsp $\log(\chi^{2}_{\text{VTX}})$ & $3.016\times10^{-2}$ & 12 & \Km ProbNNghost                      & $4.985\times 10^{-2}$\\
...
\end{tabular}
\end{center}
\caption{Ranking of variables used to train the \decay{\Dsp}{\Kp\Km\pip} and \decay{\phiz}{\Kp\Km} Run~II MVAs.}
...
\begin{figure}[!h]
   ...
   \caption{Training variables}
   \label{fig:mvatrainingvariables}   
\end{figure}
% -rw-r--r--  1 Tom  30160  14367 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_P.pdf
% -rw-r--r--  1 Tom  30160  14315 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_PT.pdf
% -rw-r--r--  1 Tom  30160  14411 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_log10_Phi_ENDVERTEX_CHI2.pdf
% -rw-r--r--  1 Tom  30160  14214 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_log10_Phi_IPCHI2_OWNPV.pdf
% -rw-r--r--  1 Tom  30160  14414 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_P.pdf
% -rw-r--r--  1 Tom  30160  14428 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_P.pdf
% -rw-r--r--  1 Tom  30160  14603 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_PT.pdf
% -rw-r--r--  1 Tom  30160  14578 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_PT.pdf
% -rw-r--r--  1 Tom  30160  14451 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_PZ.pdf
% -rw-r--r--  1 Tom  30160  14458 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_PZ.pdf
% -rw-r--r--  1 Tom  30160  14273 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_log10_Phi_K0_IPCHI2_OWNPV.pdf
% -rw-r--r--  1 Tom  30160  14295 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_log10_Phi_K1_IPCHI2_OWNPV.pdf

% -rw-r--r--  1 Tom  30160  14472 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_MC15TuneV1_ProbNNk.pdf
% -rw-r--r--  1 Tom  30160  14507 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_MC15TuneV1_ProbNNk.pdf
% -rw-r--r--  1 Tom  30160  14715 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_MC15TuneV1_ProbNNp.pdf
% -rw-r--r--  1 Tom  30160  14288 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_MC15TuneV1_ProbNNp.pdf
% -rw-r--r--  1 Tom  30160  14216 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_MC15TuneV1_ProbNNpi.pdf
% -rw-r--r--  1 Tom  30160  14230 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_MC15TuneV1_ProbNNpi.pdf
% -rw-r--r--  1 Tom  30160  14385 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_MC15TuneV1_ProbNNghost.pdf
% -rw-r--r--  1 Tom  30160  14390 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_MC15TuneV1_ProbNNghost.pdf


% -rw-r--r--  1 Tom  30160  14531 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_TRACK_CHI2NDOF.pdf
% -rw-r--r--  1 Tom  30160  14480 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_TRACK_CHI2NDOF.pdf
% -rw-r--r--  1 Tom  30160  14336 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K0_TRACK_MatchCHI2.pdf
% -rw-r--r--  1 Tom  30160  14358 18 Jan 18:02 Phi_BDT_Var_Ds2KKPi_Phi_K1_TRACK_MatchCHI2.pdf
...
{\color{Red}
\begin{itemize}
\item comparison of different MVA methods
