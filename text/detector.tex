...
The double layers of straw tubes as shown in Fig.~\ref{fig:Dec_ot_schematic} make up a module. Vertically, the modules are split in two, with staggered gaps between the two individual layers to avoid uninstrumented regions. Each of the modules are read out from the outermost end. 
