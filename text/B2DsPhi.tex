...
\end{equation}
where $g(\mu,a,b)$ represents the parabola for each of the four shapes. The parabolas used for each contribution are listed in Table~\ref{tab:DsPhi_DsstarPhi_parabolas} and the resulting invariant mass distributions are shown in Fig.\ref{eq:DsPhi_DsstarPhi_shapes}.
