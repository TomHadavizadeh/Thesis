...
Signal PDF parametrisation                  &-      & $0.036$\\ %$0.27$
...
This update determines that there is a sizeable contribution from $\decay{\Bp}{\Dsp\Kp\Km}$ decays that contribute within the $\phiz$-meson mass window that was previously not considered. 
The result is consistent with the prediction that rescattering contributions to $\decay{\Bp}{\Dsp\phiz}$ decays are small.
