...
As detailed in Sec~\ref{sec:B2DsPhi_fitcomponents}, the fit included seven parameters governing the shapes of various PDFs.
\begin{itemize}
...
\hline 
Shape                & Combinatorial slope                                                           \\ 
                     & Mean \Bp mass (\mevcc)                                                        \\  
                     & Relative heights double peaked part reco shapes                               \\  
...
\hline  
Yields               & Total Normalisation Yield in \decay{\Dsp}{\Kp\Km\pip}                   \\  
                     & Total Normalisation Yield in \decay{\Dsp}{\Kp\pim\pip}                  \\  
                     & Total Normalisation Yield in \decay{\Dsp}{\phiz\pip}                    \\  
                     & Total Normalisation Yield in \decay{\Dsp}{\pip\pim\pip}                 \\
                     & Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\Kp\Km\pip}               \\  
                     & Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\Kp\pim\pip}              \\  
                     & Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\phiz\pip}                \\  
                     & Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\pip\pim\pip}             \\  
                     & Yield of ($\Dssp\phiz$ + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\Kp\Km\pip}       \\  
                     & Yield of ($\Dssp\phiz$ + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\Kp\pim\pip}      \\  
                     & Yield of ($\Dssp\phiz$ + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\phiz\pip}        \\  
                     & Yield of ($\Dssp\phiz$ + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\Kp\pim\pip}      \\

                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\Km\pip} in 1st helicity bin             \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\Km\pip} in 2nd helicity bin             \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\pim\pip} in 1st helicity bin            \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\pim\pip} in 2nd helicity bin            \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\phiz\pip} in 1st helicity bin              \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\phiz\pip} in 2nd helicity bin              \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\pip\pim\pip} in 1st helicity bin           \\  
                     & Comb. Yield \Dsp\Dzb \decay{\Dsp}{\pip\pim\pip} in 2nd helicity bin           \\    
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\Km\pip} in 1st helicity bin            \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\Km\pip} in 2nd helicity bin            \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\pim\pip} in 1st helicity bin           \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\pim\pip} in 2nd helicity bin           \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\phiz\pip} in 1st helicity bin             \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\phiz\pip} in 2nd helicity bin             \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\pip\pim\pip} in 1st helicity bin          \\  
                     & Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\pip\pim\pip} in 2nd helicity bin          \\
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\Km\pip} in 1st helicity bin   \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\Km\pip} in 2nd helicity bin   \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\pim\pip} in 1st helicity bin  \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\pim\pip} in 2nd helicity bin  \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\phiz\pip} in 1st helicity bin    \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\phiz\pip} in 2nd helicity bin    \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\pip\pim\pip} in 1st helicity bin \\  
                     & Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\pip\pim\pip} in 2nd helicity bin \\ 
\hline 
Fractions            & Ratio of \Dsp\Kp\Km candidates to \Dsp\Dzb                                        \\  
                     & Fraction of \Dsp\Km\Kstarz in (\Dssp\Km\Kstarz+\Dsp\Km\Kstarz)                    \\ 
                     & Fraction of $\Dssp\phiz$ in ($D_{s}^{(*)+}\Km\Kstarz$ + $\Dssp\phiz$)                   \\  
                     & Ratio of $\Dsp D_{(s)}^{(*)-}$ backgrounds to ($\Dssp\phiz$ + $D_{s}^{(*)+}\Km\Kstarz$)           \\  

                     & Fraction of \Dssp\Dzb in (\Dssp\Dzb+\Dsp\Dstarzb) in 1st helicity bin         \\  
                     & Fraction of \Dssp\Dzb in (\Dssp\Dzb+\Dsp\Dstarzb) in 2nd helicity bin         \\ 
                     & Fraction of normalisation part reco in 1st helicity bin                       \\  
                     & Fraction of normalisation peak in 1st helicity bin                            \\ 
                     & Ratio of \Dssp\Dstarzb to (\Dssp\Dzb + \Dsp\Dstarzb)                          \\ 
\hline
\caption{The fit result with final values of all floating variables used in the fit model. } 
...
\item \textbf{Reconstruction:} this efficiency determines the fraction of decays in which all tracks are well reconstructed and combined into the correct candidate. The candidate must pass all requirements outlined in the \emph{Stripping Line} for the specific decay. The reconstruction selections used for both the signal and normalisation decays explicitly require that the event in which the candidate was found had fired the trigger. Therefore this efficiency includes some, but not all, of the trigger efficiency.
...
\item \textbf{Vetoes:} the efficiency of the kinematic vetoes described in Sec.\ref{sec:kinematicvetos} is included in this quantity. The efficiencies for the misidentified \D and \Lc hadrons are assumed to be the signal and normalisation channel and therefore not included in this efficiency. The misidentified hadron vetoes only target the \Dsp meson, present in both the signal and normalisation decays. The systematic uncertainty that this assumption produces is discussed in Sec.\ref{sec:B2DsPhi_systuncertainy}.
...
\subsection{Efficiencies from data}
...
\hline
Variable & Value & Symmetric Error & Asym High Error & Asym Low Error \\
\hline
Branching fraction ($\times10^{-7}$)                                                   & 1.167896 & $\pm$ 1.46377 & +1.55907 & -1.37454 \\ 
Ratio of $\Dsp\Kp\Km$ events to \Dsp\Dzb                                            & 0.024300 & $\pm$ 0.00393762 & +0.00410813 & -0.00377363 \\ 
Fraction of \Dssp\phiz in ($D_{s}^{(*)+}\Km\Kstarz$ + \Dssp\phiz               & 0.172064 & $\pm$ 0.114987 & +0.103363 & -0.134602 \\ 
Fraction of \Dssp\Dzb in (\Dssp\Dzb+\Dsp\Dstarzb) in 1st helicity bin   & 0.302051 & $\pm$ 0.0310714 & +0.0310957 & -0.031094 \\ 
Fraction of \Dssp\Dzb in (\Dssp\Dzb+\Dsp\Dstarzb) in 2nd helicity bin   & 0.341720 & $\pm$ 0.0368215 & +0.0368709 & -0.0368397 \\ 
Ratio of $\Dsp D_{(s)}^{(*)-}$ backgrounds to (\Dssp\phiz + $D_{s}^{(*)+}\Km\Kstarz$)             & 0.566997 & $\pm$ 0.116779 & +0.128702 & -0.107254 \\ 
Ratio of \Dssp\Dstarzb to (\Dssp\Dzb + \Dsp\Dstarzb)                       & 0.607422 & $\pm$ 0.015478 & +0.015621 & -0.0153371 \\ 
Fraction of \Dsp\Km\Kstarz in (\Dssp\Km\Kstarz+\Dsp\Km\Kstarz)                      & 0.663944 & $\pm$ 0.0448223 & +0.0456886 & -0.0442098 \\ 
Combinatorial slope                                                                    & -0.003252 & $\pm$ 0.000358216 & +0.000367427 & -0.000350085 \\ 
Relative heights double peaked part reco shapes                                        & 0.677350 & $\pm$ 0.0471341 & +0.0484954 & -0.0458997 \\ 
Mean B mass (\mevcc)                                                                   & 5279.098855 & $\pm$ 0.170556 & +0.170808 & -0.170369 \\ 
Part reco background mass offset (\mevcc)                                              & -1.974542 & $\pm$ 0.362046 & +0.362474 & -0.361924 \\ 
Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\Kp\Km\pip}                       & 2826.588740 & $\pm$ 51.6335 & +51.8687 & -51.3992 \\ 
Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\Kp\pim\pip}                     & 393.858122 & $\pm$ 20.1566 & +20.097 & -20.2593 \\ 
Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\phiz\pip}                     & 1733.095037 & $\pm$ 37.289 & +37.5279 & -37.0488 \\ 
Yield of (\Dssp\Dzb + \Dsp\Dstarzb) in \decay{\Dsp}{\pip\pim\pip}                   & 804.306880 & $\pm$ 25.2939 & +25.4726 & -25.1359 \\ 
Yield of (\Dssp\phiz + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\Kp\Km\pip}                & 138.730029 & $\pm$ 19.6982 & +19.4737 & -19.8388 \\ 
Yield of (\Dssp\phiz + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\Kp\pim\pip}              & 7.096855 & $\pm$ 3.82436 & +3.87374 & -3.83642 \\ 
Yield of (\Dssp\phiz + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\phiz\pip}              & 66.502638 & $\pm$ 10.404 & +10.3984 & -10.365 \\ 
Yield of (\Dssp\phiz + $D_{s}^{(*)+}\Km\Kstarz$) in \decay{\Dsp}{\Kp\pim\pip}              & 25.313567 & $\pm$ 6.60665 & +6.79583 & -6.41836 \\ 
$\sigma_{1}$ for \decay{\Dsp}{\Kp\Km\pip}  (\mevcc)                                           & 7.609946 & $\pm$ 0.178543 & +0.181767 & -0.175577 \\ 
$\sigma_{1}$ for \decay{\Dsp}{\Kp\pim\pip} (\mevcc)                                          & 8.771606 & $\pm$ 0.572254 & +0.590186 & -0.554842 \\ 
$\sigma_{1}$ for \decay{\Dsp}{\phiz\pip}  (\mevcc)                                         & 7.530819 & $\pm$ 0.214442 & +0.21795 & -0.210645 \\ 
$\sigma_{1}$ for \decay{\Dsp}{\pip\pim\pip}  (\mevcc)                                       & 8.302242 & $\pm$ 0.350017 & +0.357601 & -0.343146 \\ 
Fraction of normalisation part reco in 1st helicity bin                                & 0.593190 & $\pm$ 0.00536575 & +0.00535569 & -0.00537737 \\ 
Fraction of normalisation peak in 1st helicity bin                                     & 0.592172 & $\pm$ 0.00958993 & +0.00956661 & -0.00961301 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\Km\pip} in 1st helicity bin                         & 112.211981 & $\pm$ 27.2415 & +29.7171 & -24.9196 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\Km\pip} in 2nd helicity bin                         & 49.508665 & $\pm$ 15.2288 & +16.9114 & -13.6667 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\pim\pip} in 1st helicity bin                       & 71.321464 & $\pm$ 18.8308 & +20.2632 & -17.361 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\Kp\pim\pip} in 2nd helicity bin                       & 41.214155 & $\pm$ 11.3661 & +12.3029 & -10.4384 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\phiz\pip} in 1st helicity bin                       & 30.879073 & $\pm$ 12.64 & +14.4586 & -10.9626 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\phiz\pip} in 2nd helicity bin                       & 12.473772 & $\pm$ 7.22957 & +8.71538 & -5.89777 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\pip\pim\pip} in 1st helicity bin                     & 40.594538 & $\pm$ 12.758 & +14.1196 & -11.4669 \\ 
Comb. Yield \Dsp\Dzb \decay{\Dsp}{\pip\pim\pip} in 2nd helicity bin                     & 35.178755 & $\pm$ 12.6623 & +14.1291 & -11.2485 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\Km\pip} in 1st helicity bin                 & 32.907869 & $\pm$ 11.7119 & +13.1098 & -10.3814 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\Km\pip} in 2nd helicity bin                 & 25.920288 & $\pm$ 9.59106 & +10.5388 & -8.60011 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\pim\pip} in 1st helicity bin               & 17.808815 & $\pm$ 6.31184 & +6.84453 & -5.77765 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\Kp\pim\pip} in 2nd helicity bin               & 14.345608 & $\pm$ 5.12602 & +5.48675 & -4.77472 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\phiz\pip} in 1st helicity bin               & 5.142178 & $\pm$ 4.80805 & +6.07994 & -3.54286 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\phiz\pip} in 2nd helicity bin               & 12.029947 & $\pm$ 7.62873 & +8.33685 & -6.68294 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\pip\pim\pip} in 1st helicity bin             & 15.895551 & $\pm$ 6.78196 & +7.55101 & -5.99288 \\ 
Comb. Yield $\Dsp\phiz$ sideband \decay{\Dsp}{\pip\pim\pip} in 2nd helicity bin             & 13.751045 & $\pm$ 7.92647 & +8.15698 & -7.7326 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\Km\pip} in 1st helicity bin                          & 107.300973 & $\pm$ 21.1413 & +22.5271 & -19.7888 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\Km\pip} in 2nd helicity bin                          & 52.307013 & $\pm$ 11.4778 & +11.9854 & -10.9268 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\pim\pip} in 1st helicity bin                        & 18.960719 & $\pm$ 6.694 & +7.19079 & -6.19017 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\Kp\pim\pip} in 2nd helicity bin                        & 18.278462 & $\pm$ 4.62916 & +4.97139 & -4.3009 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\phiz\pip} in 1st helicity bin                        & 38.331966 & $\pm$ 12.8224 & +13.874 & -11.6781 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\phiz\pip} in 2nd helicity bin                        & 27.069960 & $\pm$ 7.84002 & +8.22377 & -7.43095 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\pip\pim\pip} in 1st helicity bin                      & 41.873145 & $\pm$ 9.5984 & +10.09 & -9.07919 \\ 
Comb. Yield $\Dsp\phiz$ \decay{\Dsp}{\pip\pim\pip} in 2nd helicity bin                      & 25.282391 & $\pm$ 6.5594 & +6.88293 & -6.23754 \\ 
Total Normalisation Yield \Dsp\Dzb \decay{\Dsp}{\Kp\Km\pip}                               & 1324.206680 & $\pm$ 36.6524 & +36.9821 & -36.3255 \\ 
Total Normalisation Yield \Dsp\Dzb \decay{\Dsp}{\Kp\pim\pip}                             & 182.177509 & $\pm$ 13.7813 & +14.1111 & -13.4562 \\ 
Total Normalisation Yield \Dsp\Dzb \decay{\Dsp}{\phiz\pip}                             & 800.699712 & $\pm$ 28.2849 & +28.6139 & -27.9589 \\ 
Total Normalisation Yield \Dsp\Dzb \decay{\Dsp}{\pip\pim\pip}                           & 369.298927 & $\pm$ 19.2848 & +19.6301 & -18.9444 \\
\hline
\caption{The fit result with final values of all floating variables used in the fit model. } 
\label{tab:result} 
\end{longtable}
