...
The fit to \decay{\Bp}{\Dsp\phiz} and \decay{\Bp}{\Dsp\Dzb} decays contains a total of 54 free parameters. These are listed in Tab.~\ref{tab:B2DsPhi_free_variables}. 
The majority of the partially reconstructed backgrounds do not have unconstrained yields in each of the 24 simultaneous fit categories. Instead the fractions of different background processes of left free, for example the fraction of \Dsp\Km\Kstarz decays in the sum of \Dssp\Km\Kstarz and \Dsp\Km\Kstarz decays. This single fraction is used for all \Dsp decay modes, adding stability to the lower statistics modes.
...
Type & Variable  \\
\hline
                     & Branching fraction ($\times10^{-7}$)                                          \\
                     & Ratio of \Dsp\Kp\Km candidates to \Dsp\Dzb                                    \\ 
\hline 
Shape parameters     & Combinatorial slope                                                           \\ 
                     & Mean B mass (\mevcc)                                                          \\  
...
\hline  
Fractions            & Fraction of \Dssp\Dzb in (\Dssp\Dzb+\Dsp\Dstarzb) in 1st helicity bin         \\  
