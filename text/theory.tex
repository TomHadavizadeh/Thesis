...
In the SM, the decay $\decay{\Bp}{\Dsp\phi}$ proceeds dominantly via the pure annihilation diagram shown in Fig.~\ref{fig:Theory_DsPhiDiagram}.\footnote{Unless otherwise stated, \phiz is henceforth used to refer to the $\phiz(1020)$ resonance.}  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[!h]
    \centering
