...
The fit to signal and normalisation decays have eleven and nine free parameters respectively. 
\subsection{Parameter of interest}
\begin{description}
\item \textbf{Signal:} the parameter of interest in the signal decay is $N({\Bp}{\Dsp\Kp\Km})$, the yield attributed to the signal PDF.

\item \textbf{Normalisation:} the parameter of interest in the signal decay is $N({\Bp}{\Dsp\Dzb})$, the yield attributed to the normalisation PDF.
...
\item \textbf{Signal:} the yields of each background component are left free in the signal fit.
